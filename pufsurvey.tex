...
2001年にPappuが提案したPhysical one-way functions（POWF）\cite{pappu}が，PUFの始祖とされている．
...
\begin{thebibliography}{99}% 文献数が10未満の時 {9}
  ...
  \bibitem{pappu}
  P.S. Ravilanth, “Physical One-Way Functions,” Massachusetts Institute of Technology,
  March 2001.
